...
<tr>
  <th>Past Employer Experience Certificate</th>
  <td><a href="userdocs/<?php echo $row['TenMarksheeet'];?>" target="_blank">View File </a></td>
</tr>
<tr>
  <th>Past Employment Salary slip</th>
...
<tr>
  <th>Past Employer Relive letter</th>
  <td>
...
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5> Past Employer Experience Certificate (if any)           </h5>
   <div class="form-group">
    <input class="form-control white_bg" id="hscimage" name="hscimage"  type="file">
    </div>
</fieldset>                 
</div>
</div>
...
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5>Past Employment Salary slip(if any)            </h5>
   <div class="form-group">
    <input class="form-control white_bg" id="sscimage" name="sscimage"  type="file">
    </div>
</fieldset>                 
</div>
<div class="col-xl-6 col-lg-12">
...
<div class="col-xl-4 col-lg-12">
  <fieldset>
  <h5>Past Employer Relive letter(if any)                </h5>
   <div class="form-group">
...
<p> Your KYC is pending with admin  </p>
<?php } else if($num>0 && $adstatus=='2'){ ?>
<p> Your KYC has been rejected by admin  </p>
<?php } else{?> 
  <p> First fill the Employee Form then upload docs.  </p>
<?php } ?>
          <!-- Formatter end -->
      </form>  
      </div>
