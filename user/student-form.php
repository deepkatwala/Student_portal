...
?>
<p style="font-size:16px; color:red" align="center">Your Student Registeration Form already submitted.</p>
...
<tr>
  ...
  <td><?php echo $row['Addressline1'];?>,<br/><?php echo $row['Addressline2'];?></td> 
...
<tr>
  ...
  <td><img src="userdocs/aadhardoc/<?php echo $row['StudentAadhardoc'];?>" width="200" height="150"></td>
</tr>
<tr>
  <th>Contact No</th>
