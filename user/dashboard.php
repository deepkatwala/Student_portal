...
<head>
  <title>Jainism Student Portal Form | Dashboard</title>
...
?>
<h3><font color="red">Welcome Back :</font> <?php echo $name;?> <?php echo $lname;?> </h3>
<hr />
            ...
            <div class="card pull-up">
              <div class="card-content">
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h4 align="center">You have not applied for Jainism Student Portal. Please fill the Student form.</h4>
                    </div>
                    <div>
         <i class="icon-file success font-large-2 float-right"></i>
                    </div>
...
<?php 
$rtp =mysqli_query($con ,"SELECT Id from tblstudentapplications where UserId='$uid'");
$row=mysqli_fetch_array($rtp);
?>
                    <div>
         <i class="icon-file success font-large-2 float-right"></i>
