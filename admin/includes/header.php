        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item mr-auto">
            <a class="navbar-brand" href="dashboard.php">
              ...
              <h3 class="brand-text">Jainism Admin</h3>
            </a>
          </li>
...
<?php $qury=mysqli_query($con,"SELECT tblstudentapplications.ID as appid,tbluser.FirstName,tblstudentapplications.RegistrationDate from tblstudentapplications join tbluser on tbluser.ID=tblstudentapplications.UserId where tblstudentapplications.AdminStatus is null");
...
<a href="view-appform.php?aticid=<?php echo $row['appid'];?>">
                    <div class="media">
                      ...
                      <div class="media-body">
                        <h6 class="media-heading"><b><?php echo $row['FirstName'];?></b> applied for Registration</h6>
                        <small>
<time class="media-meta text-muted" datetime="2015-06-11T18:29:20+08:00">at <?php echo $row['RegistrationDate'];?></time>
                        </small>
                      </div>
                    </div>
                  </a>
