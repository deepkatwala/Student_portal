...
<?php
$cid=$_GET['aticid'];
$query2 =mysqli_query($con,"select tbladmapplications.*,tbluser.*  from tbladmapplications inner join tbluser  on tbladmapplications.UserId = tbluser.ID where tbladmapplications.ID='$cid'");
