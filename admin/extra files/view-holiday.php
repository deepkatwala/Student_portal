            ...
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
               <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a>
                ...
                <li class="breadcrumb-item active">View Holiday
                </li>
              </ol>
            </div>
          </div>
...
?>               <div class="card-body">
  ...
  <input class="form-control white_bg" id="holiday_name" type="text" name="holiday_name" required value="<?php echo $row['holiday_name'];?>" readonly>
                          </div>
                        </fieldset>
                      </div>
					                <div class="col-xl-6 col-lg-12">
  ...
  <input class="form-control white_bg" id="from_date" type="text" name="from_date" required value="<?php echo $row['from_date'];?>" readonly>
                          </div>
                        </fieldset>
                      </div>
					                <div class="col-xl-6 col-lg-12">
  ...
  <input class="form-control white_bg" id="to_date" type="text" name="to_date" required value="<?php echo $row['to_date'];?>" readonly>
                          </div>
                        </fieldset>
                      </div>
					                <div class="col-xl-6 col-lg-12">
  ...
  <input class="form-control white_bg" id="no_days" type="text" name="no_days" required value="<?php echo $row['no_days'];?>" readonly>
                          </div>
                        </fieldset>
                      </div>
					                <div class="col-xl-6 col-lg-12">
  ...
  <input class="form-control white_bg" id="note" type="text" name="note" required value="<?php echo $row['note'];?>" readonly>
                          </div>
                        </fieldset>
                      </div>
